...
protected:
    ...
    // override = redefinir- sobre escritura - redefinir sobre el metodo
...
private:
    ...
    int mNumLineas;         //Calcular el numero de lineas que hago
    int mCase;              //Define la forma tanto para lineas, libre, rectángulos y circunferencias
};
